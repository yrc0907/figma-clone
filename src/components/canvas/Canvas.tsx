...
export default function Canvas({
  ...
  const updateMyPresence = useMutation(
    ({ setMyPresence }, newPresence: Partial<Liveblocks["Presence"]>) => {
  ...
  useEffect(() => {
    if (currentUser?.info) {
      updateMyPresence({ name: currentUser.info.name });
    }
  }, [currentUser?.info, updateMyPresence]);
  ...
  }, [deleteLayers, selectAllLayers, history]);
